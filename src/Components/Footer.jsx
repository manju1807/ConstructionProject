const Footer = () => {
  return (
    <section className="flex items-center bg-[#1f1f1f] w-[100vw]">
      <div className="container flex place-self-center bg-[#1f1f1f]">
        <div className="px-4 py-16 mx-auto sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-400 ">
                  <a className="hover:text-actionColor" href="#">
                    {" "}
                    About Company{" "}
                  </a>
                  <a className="hover:text-actionColor" href="#">
          ...
          <p className="mt-8 text-s text-gray-400 text-center">
            © Logo * <span className="px-[.3rem]"></span> All rights reserved.
          </p>
        </div>
      </div>
    </section>
