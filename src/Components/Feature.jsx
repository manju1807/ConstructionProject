...
const Feature = () => {
  return (
    <section className="relative h-[100vh] w-[100vw] overflow-y-auto md:overflow-hidden">
      <div className="container flex flex-col overflow-y-auto md:overflow-hidden">
        ...
        <div
          className="w-full h-[30vh] relative flex flex-col space-y-4 py-4 md:py-6 items-center"
          style={{
